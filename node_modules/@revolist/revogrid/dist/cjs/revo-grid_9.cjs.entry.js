...
const index = require('./index-7a22fa96.js');
...
const RevoGridComponent = class {
    ...
    render() {
        return index.h("revogr-viewport", { onSetDimensionSize: e => this.dimensionProvider.setDimensionSize(e.detail.type, e.detail.sizes), onSetViewportCoordinate: e => this.dimensionProvider.setViewPortCoordinate(e.detail), onSetViewportSize: e => this.viewportProvider.setViewport(e.detail.dimension, { virtualSize: e.detail.size }), columnStores: this.columnStores, dimensions: this.dimensionStores, viewports: this.viewportStores, rowStores: this.rowStores, dataProvider: this.dataProvider, uuid: this.uuid, resize: this.resize, readonly: this.readonly, range: this.range });
    }
...
class ColumnService {
    ...
    cellRenderer(r, c) {
        ...
        if (tpl) {
            return tpl(index.h, this.rowDataModel(r, c));
        }
    ...
    render() {
        ...
        for (let row of this.rows) {
            ...
            for (let col of this.cols) {
                ...
                cells.push(index.h("div", Object.assign({}, dataProps), this.columnService.cellRenderer(row.itemIndex, col.itemIndex)));
            }
        ...
        if (!this.readonly || this.range) {
            rowsEls.push(index.h("revogr-overlay-selection", { slot: 'content', selectionStoreConnector: this.selectionStoreConnector, readonly: this.readonly, columnService: this.columnService, dimensionCol: this.dimensionCol, dimensionRow: this.dimensionRow, lastCell: this.lastCell, position: this.position, parent: parent }));
        }
        return index.h(index.Host, Object.assign({}, hostProp), rowsEls);
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
        "colData": ["colChanged"]
...
const Edit = class {
    ...
    render() {
        ...
        return index.h("div", { style: style, class: 'edit-input-wrapper' }, index.h("revogr-text-editor", { value: this.editCell.val, onEdit: (e) => this.onSave(e) }));
    }
};
...
const RevogrHeaderComponent = class {
    ...
    render() {
        ...
        for (let col of this.cols) {
            ...
            cells.push(index.h("div", Object.assign({}, dataProps), colData.name));
            ...
            if (this.groups[i]) {
                for (let group of this.groups[i]) {
                    ...
                    if (indexFirstVisibleCol > -1) {
                        ...
                        groupRow.push(index.h("div", Object.assign({}, groupProps), group.name));
                    }
                }
            }
            groupRow.push(index.h("div", { class: 'header-row group' }));
        }
        return [
            index.h("div", { class: 'group-row' }, groupRow),
            index.h("div", { class: 'header-row' }, cells)
        ];
    }
    get element() { return index.getElement(this); }
    static get watchers() { return {
...
const OverlaySelection = class {
    ...
    render() {
        ...
        if (range) {
            ...
            els.push(index.h("div", { class: SELECTION_BORDER_CLASS, style: style }), index.h("div", { class: SELECTION_BG_CLASS, style: style }));
        }
        if (tempRange) {
            const style = this.getElStyle(tempRange);
            els.push(index.h("div", { class: TMP_SELECTION_BG_CLASS, style: style }));
        }
        let focusStyle = {};
        if (selectionFocus) {
            ...
            els.push(index.h("div", { class: FOCUS_CLASS, style: focusStyle }));
        }
        els.push(index.h("input", { type: 'text', class: 'edit-focus-input', ref: el => this.focusSection = el, style: focusStyle }));
        if (!this.readonly) {
            const editCell = this.selectionStore.store.get('edit');
            els.push(index.h("revogr-edit", { onCloseEdit: () => this.selectionStoreConnector.setEdit(false), editCell: editCell && Object.assign(Object.assign({}, editCell), { val: editCell.val || this.columnService.getCellData(editCell.y, editCell.x) }), dimensionRow: this.dimensionRow, dimensionCol: this.dimensionCol }));
        }
        return els;
    }
    getElStyle(range) {
...
const RevogrScrollVirtual = class {
    ...
    render() {
        ...
        return index.h(index.Host, { onScroll: (e) => {
                var _a;
            ...
            } }, index.h("div", { style: { [sizeType]: `${this.extContentSize}px` } }));
    }
    get element() { return index.getElement(this); }
};
...
const TextEditor = class {
    ...
    render() {
        return index.h("input", { type: 'text', ref: (el) => { this.editInput = el; }, onKeyDown: (e) => this.onKeyDown(e) });
    }
    onKeyDown(e) {
        const isEnter = codesLetter.ENTER === e.code;
        if (isEnter && e.target) {
...
const RevogrViewport = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.setDimensionSize = index.createEvent(this, "setDimensionSize", 7);
        this.setViewportCoordinate = index.createEvent(this, "setViewportCoordinate", 7);
        this.setViewportSize = index.createEvent(this, "setViewportSize", 7);
    ...
    render() {
        ...
        for (let view of viewports) {
            ...
            for (let data of view.dataPorts) {
                dataViews.push(index.h("revogr-data", Object.assign({}, data, { selectionStoreConnector: this.selectionStoreConnector, key: view.prop.key + (++j), readonly: this.readonly, range: this.range })));
            }
            viewPortHtml.push(index.h("revogr-viewport-scroll", Object.assign({}, view.prop, { ref: el => this.elementToScroll.push(el), onScrollViewport: e => this.scrollingService.onScroll(e.detail, view.prop.key) }), index.h("revogr-header", Object.assign({}, view.headerProp, { slot: 'header', canResize: this.resize })), dataViews));
        }
        return index.h(index.Host, Object.assign({}, { [`${UUID}`]: this.uuid }), index.h("div", { class: 'main-viewport' }, index.h("div", { class: 'viewports' }, viewPortHtml, index.h("revogr-scroll-virtual", { class: 'vertical', contentSize: contentHeight, ref: el => this.elementToScroll.push(el), virtualSize: this.viewports['row'].get('virtualSize'), onScrollVirtual: e => this.scrollingService.onScroll(e.detail) }))), index.h("revogr-scroll-virtual", { class: 'horizontal', dimension: 'col', contentSize: this.dimensions['col'].get('realSize'), ref: el => this.elementToScroll.push(el), virtualSize: this.viewports['col'].get('virtualSize'), onScrollVirtual: e => this.scrollingService.onScroll(e.detail) }));
    }
...
class GridResizeService {
    ...
    async init(el) {
        ...
        if (!('ResizeObserver' in window)) {
            const module = await Promise.resolve().then(function () { return require('./resize-observer-aeccf0a6.js'); });
...
const RevogrViewportScroll = class {
    ...
    render() {
        return index.h("div", { class: 'inner-content-table', style: { width: `${this.contentWidth}px` } }, index.h("div", { class: 'header-wrapper' }, index.h("slot", { name: 'header' })), index.h("div", { class: 'vertical-inner', ref: el => { this.verticalScroll = el; } }, index.h("div", { class: 'content-wrapper', style: { height: `${this.contentHeight}px`, } }, index.h("slot", { name: 'content' }))), index.h("div", { class: 'footer-wrapper' }, index.h("slot", { name: 'footer' })));
    }
...
exports.revogr_text_editor = TextEditor;
exports.revogr_viewport = RevogrViewport;
